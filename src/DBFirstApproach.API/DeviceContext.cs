...
public partial class DeviceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F65597CE98").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E71947E7012").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E381A00D33C").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D10534C6C3B8EE").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F62D727CEB").IsUnique();
